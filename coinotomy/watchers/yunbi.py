...
watchers = [
    WatcherYunbi("btc/cny", "btccny"),
    WatcherYunbi("eth/cny", "ethcny"),
    WatcherYunbi("dgd/cny", "dgdcny"),
    WatcherYunbi("dcs/cny", "dcscny"),
    WatcherYunbi("sc/cny", "sccny"),
    WatcherYunbi("etc/cny", "etccny"),
    WatcherYunbi("1st/cny", "1stcny"),
    WatcherYunbi("rep/cny", "repcny"),
    WatcherYunbi("ans/cny", "anscny"),
    WatcherYunbi("zec/cny", "zeccny"),
    WatcherYunbi("zmc/cny", "zmccny"),
    WatcherYunbi("gnt/cny", "gntcny"),
    WatcherYunbi("pls/cny", "plscny"),
    WatcherYunbi("bts/cny", "btscny"),
    WatcherYunbi("bitcny/cny", "bitcnycny"),
]
